...
var lastAngeZhugongDateMap = map[string]time.Time{
	"wei": newDate(2023, 5, 26),
	"shu": newDate(2023, 11, 10),
	"wu":  newDate(2023, 9, 15),
	"qun": newDate(2023, 7, 21),
}

var countryHerosMap = map[string][]string{
	"wei": {"曹丕", "张春华", "蔡文姬", "曹仁", "司马懿", "夏侯惇", "张辽", "郭嘉"},
	"shu": {"姜维", "徐庶", "马岱", "庞统", "诸葛亮", "张飞", "赵云", "关羽"},
	"wu":  {"孙尚香", "陆逊", "大乔", "孙坚", "黄盖", "周瑜", "孙策", "小乔"},
	"qun": {"于吉", "SP华佗", "左慈", "董卓", "李儒", "貂蝉", "祝融", "吕布"},
}

var countryHerosMapWithZhugong = map[string][]string{
	"wei": {"曹操", "曹丕", "张春华", "蔡文姬", "曹仁", "司马懿", "夏侯惇", "张辽", "郭嘉"},
	"shu": {"刘备", "姜维", "徐庶", "马岱", "庞统", "诸葛亮", "张飞", "赵云", "关羽"},
	"wu":  {"孙权", "孙尚香", "陆逊", "大乔", "孙坚", "黄盖", "周瑜", "孙策", "小乔"},
	"qun": {"袁绍", "于吉", "SP华佗", "左慈", "董卓", "李儒", "貂蝉", "祝融", "吕布"},
}
